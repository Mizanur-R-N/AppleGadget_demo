...
public class OrderProductPayment extends Initialization{
    ...
    void ConfirmOrderProduct(String cus_name, String cus_email,String cus_mbl, String cus_add) throws InterruptedException {
        objcheckout = new CheckoutPage(driver);
        objcheckout.ConfirmPaymentOrder(cus_name, cus_email, cus_mbl,cus_add);
        Thread.sleep(10000);
    }
